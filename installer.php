...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'hmdpharmahcm_6f63d61bce8c89558080_20210713061611_archive.zip';
	const ARCHIVE_SIZE		 = '313377462';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6f63d61-13061611';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.1.1==');
		self::log('----------------------------------------------------');
